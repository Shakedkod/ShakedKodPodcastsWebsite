...
export const PODCASTS: { [name: string]: RSSDataProps } = {
    "PWAS": {
        ...
        language: "he",
        image: "https://podcasts.shakedkod.tech/podcasts-assets/PWAS/logo.png",
        ...
        episodes: [
            // Episode 8
            {
                ...
                audio: {
                    url: "https://github.com/Shakedkod/Podcasts.ShakedKod.tech/raw/gh-pages/podcast-assets/PWAS/audio/Ep8.mp3",
                    size: 1153000,
                    type: "audio/mp3",
                },
                subtitle: "בפרק זה אנחנו נתחקה אחר הפיראטים היהודיים וסיפוריהם המרתקים, בנוסף נדבר על ספרד, מרוקו וכמה אנשים מרתקים.&#13; האזנה נעימה,&#13; שקד!&#13;",
                image: "http://podcasts.shakedkod.tech/podcast-assets/PWAS/images/Ep8.png",
                duration: "1153",
                explicit: "clean",
                episodeType: "full",
                season: 2
            ...
            // Episode 7
            {
                ...
                audio: {
                    url: "https://github.com/Shakedkod/Podcasts.ShakedKod.tech/raw/gh-pages/podcast-assets/PWAS/audio/Ep7.mp3",
                    size: 1153000,
                    type: "audio/mp3",
                },
                subtitle: "ראיון של קבוצת המשצים עם עודד נגבי, חבלן בחטיבה 5&#13;_____________________________________________&#13;&#13;כל הזכויות שמורות לרדיו בן צבי - 2022",
                image: "http://podcasts.shakedkod.tech/podcast-assets/PWAS/images/Ep7.png",
                duration: "1153",
                explicit: "clean",
                episodeType: "bonus",
                season: 1
            ...
            // Episode 6
            {
                ...
                audio: {
                    url: "https://github.com/Shakedkod/Podcasts.ShakedKod.tech/raw/gh-pages/podcast-assets/PWAS/audio/Ep6.mp3",
                    size: 13578498,
                    type: "audio/mp3",
                },
                subtitle: "בפרק זה אני דיברתי על העיר שבתוך העיר שבמדינה שבתוך מדינה,&#13;יותר לא אגלה,&#13;האזנה נעימה,&#13;",
                image: "http://podcasts.shakedkod.tech/podcast-assets/PWAS/images/Ep6.png",
                duration: "849",
                explicit: "clean",
                episodeType: "full",
                season: 1
            ...
            // Episode 5
            {
                ...
                audio: {
                    url: "https://github.com/Shakedkod/Podcasts.ShakedKod.tech/raw/gh-pages/podcast-assets/PWAS/audio/Ep5.mp3",
                    size: 6777350,
                    type: "audio/mp3",
                },
                subtitle: "בפרק זה תוכלו לשמוע על הקמפיין ששינה את המדינה לחלוטין&#13;קמפיין פרחי הבר!&#13;וזה יותר מעניין משאתם חושבים,&#13;האזנה נעימה,&#13;",
                image: "http://podcasts.shakedkod.tech/podcast-assets/PWAS/images/Ep5.png",
                duration: "424",
                explicit: "clean",
                episodeType: "full",
                season: 1
            ...
            // Episode 4
            {
                ...
                audio: {
                    url: "https://github.com/Shakedkod/Podcasts.ShakedKod.tech/raw/gh-pages/podcast-assets/PWAS/audio/Ep4.mp3",
                    size: 12912936,
                    type: "audio/mp3",
                },
                subtitle: "בחלק השני של מצות ועוד מצות התמקדתי בעלילות והדם והסיפור שלהם עם המצות&#13;הפרק הזה קצת יותר קריפי מבדרך כלל&#13;אך מהנה לא פחות&#13;האזנה נעימה,&#13;",
                image: "http://podcasts.shakedkod.tech/podcast-assets/PWAS/images/Ep4.png",
                duration: "807",
                explicit: "clean",
                episodeType: "full",
                season: 1
            ...
            // Episode 3
            {
                ...
                audio: {
                    url: "https://github.com/Shakedkod/Podcasts.ShakedKod.tech/raw/gh-pages/podcast-assets/PWAS/audio/Ep3.mp3",
                    size: 7025145,
                    type: "audio/mp3",
                },
                subtitle: "בפרק זה של פודקאסט ללא נושא, ספיישל פסח ואיתו הסיפור על המצות&#13;מהתקופה התנכית ועד היום&#13;זהו חלק אחד מתוך שניים, והשני יפורסם בערב חג שני&#13;האזנה נעימה,&#13;",
                image: "http://podcasts.shakedkod.tech/podcast-assets/PWAS/images/Ep3.png",
                duration: "439",
                explicit: "clean",
                episodeType: "full",
                season: 1
            ...
            // Episode 2
            {
                ...
                audio: {
                    url: "https://github.com/Shakedkod/Podcasts.ShakedKod.tech/raw/gh-pages/podcast-assets/PWAS/audio/Ep2.mp3",
                    size: 5765053,
                    type: "audio/mp3",
                },
                subtitle: "בפרק קצר זה של פודקאסט ללא נושא, אני אדבר על ההיסטוריה, והעתיד של האוטובוסים ועוד כמה דברים,&#13;האזנה נעימה,&#13;",
                image: "http://podcasts.shakedkod.tech/podcast-assets/PWAS/images/Ep2.png",
                duration: "361",
                explicit: "clean",
                episodeType: "full",
                season: 1
            ...
            // Episode 1
            {
                ...
                audio: {
                    url: "https://github.com/Shakedkod/Podcasts.ShakedKod.tech/raw/gh-pages/podcast-assets/PWAS/audio/Ep1.mp3",
                    size: 15984922,
                    type: "audio/mp3",
                },
                subtitle: "בפרק זה של פודקאסט ללא נושא אני אדבר על זיהום אור, ולמה כל כך הרבה אור זה רע לנו&#13;ועל לווייתנאים גם כן.&#13;האזנה נעימה,&#13;",
                image: "http://podcasts.shakedkod.tech/podcast-assets/PWAS/images/Ep1.png",
                duration: "1000",
                explicit: "clean",
                episodeType: "full",
                season: 1
    ...
    "ATWAS": {
        ...
        language: "he",
        image: "http://podcasts.shakedkod.tech/podcasts/ATWAS/assets/images/ATWAS.png",
        ...
        episodes: [
            // Episode 9
            {
                ...
                audio: {
                    url: "https://github.com/Shakedkod/Podcasts.ShakedKod.tech/raw/gh-pages/podcasts/ATWAS/assets/audio/2309.mp3",
                    size: 1867000,
                    type: "audio/mp3",
                },
            ...
            // Episode 8
            {
                ...
                audio: {
                    url: "https://github.com/Shakedkod/Podcasts.ShakedKod.tech/raw/gh-pages/podcasts/ATWAS/assets/audio/2308.m4a",
                    size: 2598000,
                    type: "audio/mp4",
                },
            ...
            // Episode 7
            {
                ...
                audio: {
                    url: "https://github.com/Shakedkod/Podcasts.ShakedKod.tech/raw/gh-pages/podcasts/ATWAS/assets/audio/2207.mp3",
                    size: 3357000,
                    type: "audio/mp3",
                },
            ...
            // Episode 6
            {
                ...
                audio: {
                    url: "https://github.com/Shakedkod/Podcasts.ShakedKod.tech/raw/gh-pages/podcasts/ATWAS/assets/audio/2206.mp3",
                    size: 3059000,
                    type: "audio/mp3",
                },
            ...
            // Episode 5
            {
                ...
                audio: {
                    url: "https://github.com/Shakedkod/Podcasts.ShakedKod.tech/raw/gh-pages/podcasts/ATWAS/assets/audio/2205.mp3",
                    size: 1260000,
                    type: "audio/mp3",
                },
            ...
            // Episode 4
            {
                ...
                audio: {
                    url: "https://github.com/Shakedkod/Podcasts.ShakedKod.tech/raw/gh-pages/podcasts/ATWAS/assets/audio/2204.mp3",
                    size: 2343000,
                    type: "audio/mp3",
                },
            ...
            // Episode 3
            {
                ...
                audio: {
                    url: "https://github.com/Shakedkod/Podcasts.ShakedKod.tech/raw/gh-pages/podcasts/ATWAS/assets/audio/2203.mp3",
                    size: 2750000,
                    type: "audio/mp3",
                },
            ...
            // Episode 2
            {
                ...
                audio: {
                    url: "https://github.com/Shakedkod/Podcasts.ShakedKod.tech/raw/gh-pages/podcasts/ATWAS/assets/audio/2202.mp3",
                    size: 99038918,
                    type: "audio/mp3",
                },
            ...
            // Episode 1
            {
                ...
                audio: {
                    url: "https://github.com/Shakedkod/Podcasts.ShakedKod.tech/raw/gh-pages/podcasts/ATWAS/assets/audio/2201.mp3",
                    size: 99038918,
                    type: "audio/mp3",
                },
    ...
    "ST": {
        ...
        language: "he",
        image: "http://podcasts.shakedkod.tech/podcasts/ST/assets/images/logo.png",
        ...
        episodes: [
            ...
            // Episode 21
            {
                ...
                audio: {
                    url: "https://github.com/Shakedkod/Podcasts.ShakedKod.tech/raw/gh-pages/podcasts/ST/assets/audio/2023/TestsInSchool.mp3",
                    size: 721000,
                    type: "audio/mp3",
                },
                ...
                image: "http://podcasts.shakedkod.tech/podcasts/ST/assets/images/2023/TestsInSchool.png",
                duration: "721",
                explicit: "clean",
                episodeType: "full",
                season: 2
            ...
            // Episode 20
            {
                ...
                date: "Sat, 17 Jun 2023 20:00:00 +0000",
                audio: {
                    url: "https://github.com/Shakedkod/Podcasts.ShakedKod.tech/raw/gh-pages/podcasts/ST/assets/audio/2023/Dictatorship.mp3",
                    size: 1392000,
                    type: "audio/mp3",
                },
                subtitle: 'מתעניינים בפוליטיקה? רוצים לדעת יותר על מה שקורה במדינה? היכנסו לפודקאסט!!\nהסכת זה עוסק בדילמה הציבורית הבולטת ביותר בזמן האחרון, הרפורמה/מהפכה/הפיכה המשפטית. \nמסגרת הסכת נארח פאנל תלמידים בעד ונגד הרפורמה.',
                image: "http://podcasts.shakedkod.tech/podcasts/ST/assets/images/2023/Dictatorship.png",
                duration: "1392",
                explicit: "clean",
                episodeType: "full",
                season: 2
            ...
            // Episode 19
            {
                ...
                date: "Sat, 17 Jun 2023 20:00:00 +0000",
                audio: {
                    url: "https://github.com/Shakedkod/Podcasts.ShakedKod.tech/raw/gh-pages/podcasts/ST/assets/audio/2023/HerOwnCourt.mp3",
                    size: 795000,
                    type: "audio/mp3",
                },
                ...
                image: "http://podcasts.shakedkod.tech/podcasts/ST/assets/images/2023/HerOwnCourt.png",
                duration: "795",
                explicit: "clean",
                episodeType: "full",
                season: 2
            ...
            // Episode 18
            {
                ...
                date: "Sat, 17 Jun 2023 20:00:00 +0000",
                audio: {
                    url: "https://github.com/Shakedkod/Podcasts.ShakedKod.tech/raw/gh-pages/podcasts/ST/assets/audio/2023/Tests.mp3",
                    size: 1178000,
                    type: "audio/mp3",
                },
                ...
                image: "http://podcasts.shakedkod.tech/podcasts/ST/assets/images/2023/Tests.png",
                duration: "1178",
                explicit: "clean",
                episodeType: "full",
                season: 2
            ...
            // Episode 17
            {
                ...
                date: "Sat, 17 Jun 2023 20:00:00 +0000",
                audio: {
                    url: "https://github.com/Shakedkod/Podcasts.ShakedKod.tech/raw/gh-pages/podcasts/ST/assets/audio/2023/Medic.mp3",
                    size: 691000,
                    type: "audio/mp3",
                },
                ...
                image: "http://podcasts.shakedkod.tech/podcasts/ST/assets/images/2023/Medic.png",
                duration: "691",
                explicit: "clean",
                episodeType: "full",
                season: 2
            ...
            // Episode 16
            {
                ...
                date: "Sat, 17 Jun 2023 20:00:00 +0000",
                audio: {
                    url: "https://github.com/Shakedkod/Podcasts.ShakedKod.tech/raw/gh-pages/podcasts/ST/assets/audio/2023/GlobalWarming.mp3",
                    size: 770000,
                    type: "audio/mp3",
                },
                subtitle: '-זיהום וגזי חממה וההשפעה שלהם\n-תחליפים לייצור אנרגיה מנפט ופחם\n-תעשיית הבשר משפיעה יותר משחושבים\n-אנרגיה ירוקה ומכוניות חשמליות\n\nאנחנו רוצים להעלות מודעות לנושא מפני שכולם יודעים עליו אבל בסופו של דבר לא חושבים עליו מספיק ובסוף שוכחים לרוב אז אנחנו באנו להזכיר שהמצב עוד קיים והוא לא הכי משתפר ועל הדרך לדבר ולהסביר לאלה ששכחו או לא יודעים מה הגורמים מה מתכננים לעשות במידה בינלאומית ומה לעשות בעצמם כדי לעזור.',
                image: "http://podcasts.shakedkod.tech/podcasts/ST/assets/images/2023/GlobalWarming.png",
                duration: "770",
                explicit: "clean",
                episodeType: "full",
                season: 2
            ...
            // Episode 15
            {
                ...
                date: "Sat, 17 Jun 2023 20:00:00 +0000",
                audio: {
                    url: "https://github.com/Shakedkod/Podcasts.ShakedKod.tech/raw/gh-pages/podcasts/ST/assets/audio/2023/TheUqrainWar.mp3",
                    size: 703000,
                    type: "audio/mp3",
                },
                ...
                image: "http://podcasts.shakedkod.tech/podcasts/ST/assets/images/2023/TheUqrainWar.png",
                duration: "703",
                explicit: "clean",
                episodeType: "full",
                season: 2
            ...
            // Episode 14
            {
                ...
                date: "Sat, 17 Jun 2023 20:00:00 +0000",
                audio: {
                    url: "https://github.com/Shakedkod/Podcasts.ShakedKod.tech/raw/gh-pages/podcasts/ST/assets/audio/2023/Nobel.mp3",
                    size: 380000,
                    type: "audio/mp3",
                },
                subtitle: 'אלפרד נובל היה כימאי צעיר כשגילה על הניטרוגליצרין. הוא התנסה עם החומר ולמד איך לשלוט בו תוך שאיבד דברים חשובים לו כמו משפחה אך למרות הכל המשיך עד שהצליח לשלוט בפיצוץ הניטרוגליצרין. הוא קרא להמצאה שלו "דינמיט". הדינמיט גרמה להרס ואבדנות רבים בעולם ולכן אלפרד החליט להקים עם הירושה שלו קרן שאנחנו מכירים בתור "פרס נובל" אשר תעניק מדי שנה פרסים לאנשים פורצי דרך שעזרו לעולם בשלל תחומים כגון שלום. \nבפודקאסט גם נדבר על תקרית טובה ותקרית רעה שקרו בעקבות המצאת הדינמיט ומה ההשלכות שלהן על העולם. האזנה נעימה!',
                image: "http://podcasts.shakedkod.tech/podcasts/ST/assets/images/2023/Nobel.png",
                duration: "380",
                explicit: "clean",
                episodeType: "full",
                season: 2
            ...
            // Episode 13
            {
                ...
                date: "Sat, 17 Jun 2023 20:00:00 +0000",
                audio: {
                    url: "https://github.com/Shakedkod/Podcasts.ShakedKod.tech/raw/gh-pages/podcasts/ST/assets/audio/2023/Intercetions.mp3",
                    size: 1400000,
                    type: "audio/mp3",
                },
                ...
                image: "http://podcasts.shakedkod.tech/podcasts/ST/assets/images/2023/Intercetions.png",
                duration: "1400",
                explicit: "clean",
                episodeType: "full",
                season: 2
            ...
            // Episode 12
            {
                ...
                date: "Sat, 17 Jun 2023 20:00:00 +0000",
                audio: {
                    url: "https://github.com/Shakedkod/Podcasts.ShakedKod.tech/raw/gh-pages/podcasts/ST/assets/audio/2023/Trends.mp3",
                    size: 420000,
                    type: "audio/mp3",
                },
                ...
                image: "http://podcasts.shakedkod.tech/podcasts/ST/assets/images/2023/Trends.png",
                duration: "420",
                explicit: "clean",
                episodeType: "full",
                season: 2
            ...
            // Episode 11
            {
                ...
                date: "Sat, 17 Jun 2023 20:00:00 +0000",
                audio: {
                    url: "https://github.com/Shakedkod/Podcasts.ShakedKod.tech/raw/gh-pages/podcasts/ST/assets/audio/2023/Mars.mp3",
                    size: 926000,
                    type: "audio/mp3",
                },
                ...
                image: "http://podcasts.shakedkod.tech/podcasts/ST/assets/images/2023/Mars.png",
                duration: "926",
                explicit: "clean",
                episodeType: "full",
                season: 2
            ...
            // Episode 10
            {
                ...
                date: "Sat, 17 Jun 2023 20:00:00 +0000",
                audio: {
                    url: "https://github.com/Shakedkod/Podcasts.ShakedKod.tech/raw/gh-pages/podcasts/ST/assets/audio/2023/TheJustisSystem.mp3",
                    size: 399000,
                    type: "audio/mp3",
                },
                ...
                image: "http://podcasts.shakedkod.tech/podcasts/ST/assets/images/2023/TheJustisSystem.png",
                duration: "399",
                explicit: "clean",
                episodeType: "full",
                season: 2
            ...
            // Episode 9
            {
                ...
                date: "Sat, 17 Jun 2023 20:00:00 +0000",
                audio: {
                    url: "https://github.com/Shakedkod/Podcasts.ShakedKod.tech/raw/gh-pages/podcasts/ST/assets/audio/2023/LGBTQ.mp3",
                    size: 618000,
                    type: "audio/mp3",
                },
                ...
                image: "http://podcasts.shakedkod.tech/podcasts/ST/assets/images/2023/LGBTQ.png",
                duration: "618",
                explicit: "clean",
                episodeType: "full",
                season: 2
            ...
            // Episode 8
            {
                ...
                date: "Sat, 17 Jun 2023 20:00:00 +0000",
                audio: {
                    url: "https://github.com/Shakedkod/Podcasts.ShakedKod.tech/raw/gh-pages/podcasts/ST/assets/audio/2023/FromReligusToNot.mp3",
                    size: 780000,
                    type: "audio/mp3",
                },
                subtitle: 'הפודקאסט עוסק על בתהליך של שרה לסטר ביציאתה בשאלה.\nמסופר שם כיצד היא התמודדה עם התהליך, מה היו השאיפות שלה\nומדוע רצתה לצאת ולעזוב את החברה החרדית. סיפור מאוד מעניין, לא כדאי\nלאף אחד לפספס',
                image: "http://podcasts.shakedkod.tech/podcasts/ST/assets/images/2023/FromReligusToNot.png",
                duration: "780",
                explicit: "clean",
                episodeType: "full",
                season: 2
            ...
            // Episode 7
            {
                ...
                audio: {
                    url: "https://github.com/Shakedkod/Podcasts.ShakedKod.tech/raw/gh-pages/podcasts/ST/assets/audio/2022/drugsWitrhTeens.mp3",
                    size: 7457623,
                    type: "audio/mp3",
                },
                subtitle: "",
            ...
            // Episode 6
            {
                ...
                date: "Sat, 17 Jun 2022 20:00:00 +0000",
                audio: {
                    url: "https://github.com/Shakedkod/Podcasts.ShakedKod.tech/raw/gh-pages/podcasts/ST/assets/audio/2022/Bagrot.mp3",
                    size: 8104506,
                    type: "audio/mp3",
                },
                subtitle: "",
            ...
            // Episode 5
            {
                ...
                date: "Sat, 17 Jun 2022 20:00:00 +0000",
                audio: {
                    url: "https://github.com/Shakedkod/Podcasts.ShakedKod.tech/raw/gh-pages/podcasts/ST/assets/audio/2022/Tests.mp3",
                    size: 10436902,
                    type: "audio/mp3",
                },
                subtitle: "",
            ...
            // Episode 4
            {
                ...
                date: "Sat, 17 Jun 2022 20:00:00 +0000",
                audio: {
                    url: "https://github.com/Shakedkod/Podcasts.ShakedKod.tech/raw/gh-pages/podcasts/ST/assets/audio/2022/Vegetarian.mp3",
                    size: 16417160,
                    type: "audio/mp3",
                },
                subtitle: "",
            ...
            // Episode 3
            {
                ...
                date: "Sat, 17 Jun 2022 20:00:00 +0000",
                audio: {
                    url: "https://github.com/Shakedkod/Podcasts.ShakedKod.tech/raw/gh-pages/podcasts/ST/assets/audio/2022/GunInUS.mp3",
                    size: 7261120,
                    type: "audio/mp3",
                },
                subtitle: "",
            ...
            // Episode 2
            {
                ...
                date: "Sat, 17 Jun 2022 20:00:00 +0000",
                audio: {
                    url: "https://github.com/Shakedkod/Podcasts.ShakedKod.tech/raw/gh-pages/podcasts/ST/assets/audio/2022/Opinions.mp3",
                    size: 5173222,
                    type: "audio/mp3",
                },
                subtitle: "",
            ...
            // Episode 1
            {
                ...
                date: "Sat, 17 Jun 2022 20:00:00 +0000",
                audio: {
                    url: "https://github.com/Shakedkod/Podcasts.ShakedKod.tech/raw/gh-pages/podcasts/ST/assets/audio/2022/Companies.mp3",
                    size: 11393545,
                    type: "audio/mp3",
                },
                subtitle: "",
